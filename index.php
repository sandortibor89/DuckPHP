...
define('APP_PUBLIC_CSS_DIR', APP_PUBLIC_ASSETS_DIR.DS.'stylesheets');
$dirs_check[] = APP_PUBLIC_CSS_DIR;
define('APP_PUBLIC_CSS_URL', APP_PUBLIC_ASSETS_URL.'/stylesheets');
define('APP_PUBLIC_SASS_DIR', APP_PUBLIC_ASSETS_DIR.DS.'sass');
$dirs_check[] = APP_PUBLIC_SASS_DIR;
define('APP_PUBLIC_SCSS_URL', APP_PUBLIC_ASSETS_URL.'/sass');
define('APP_PUBLIC_IMG_DIR', APP_PUBLIC_ASSETS_DIR.DS.'images');
$dirs_check[] = APP_PUBLIC_IMG_DIR;
define('APP_PUBLIC_IMG_URL', APP_PUBLIC_ASSETS_URL.'/images');
define('APP_PUBLIC_JS_DIR', APP_PUBLIC_ASSETS_DIR.DS.'javascripts');
$dirs_check[] = APP_PUBLIC_JS_DIR;
define('APP_PUBLIC_JS_URL', APP_PUBLIC_ASSETS_URL.'/javascripts');
define('APP_PUBLIC_PLUGINS_DIR', APP_PUBLIC_ASSETS_DIR.DS.'plugins');
$dirs_check[] = APP_PUBLIC_PLUGINS_DIR;
define('APP_PUBLIC_PLUGINS_URL', APP_PUBLIC_ASSETS_URL.'/plugins');
...
define('APP_CSS_DIR', APP_ASSETS_DIR.DS.'stylesheets');
$dirs_check[] = APP_CSS_DIR;
define('APP_CSS_URL', APP_ASSETS_URL.'/stylesheets');
define('APP_SCSS_DIR', APP_ASSETS_DIR.DS.'sass');
$dirs_check[] = APP_SCSS_DIR;
define('APP_SCSS_URL', APP_ASSETS_URL.'/sass');
define('APP_IMG_DIR', APP_ASSETS_DIR.DS.'images');
$dirs_check[] = APP_IMG_DIR;
define('APP_IMG_URL', APP_ASSETS_URL.'/images');
define('APP_JS_DIR', APP_ASSETS_DIR.DS.'javascripts');
$dirs_check[] = APP_JS_DIR;
define('APP_JS_URL', APP_ASSETS_URL.'/javascripts');
